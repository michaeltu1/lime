...
class LimeImageExplainer(object):
    ...
    def explain_instance_2(self, image, classifier_fn, labels=(1,),
        ...
        for label in top:
            ...
            stats["easy_models"].append[easy_models]
            stats["prediction_scores"].append[prediction_scores]
            stats["local_preds"].append[local_preds]
            stats["temps_masks"].append[temps_masks]
