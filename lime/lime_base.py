...
class LimeBase(object):
    ...
    def explain_instance_with_data_2(self, 
                                     neighborhood_data, 
                                     neighborhood_labels, 
                                     distances, 
                                     label, 
      ...
      for i in range(num_samples):
          ...
          temp, mask = self.get_temp_and_mask(label, segments, image, exp, positive_only=False, 
                           hide_rest=False, num_features=10, min_weight=0., outline=False)
          temps_masks.append(temp, mask)

      return easy_models, prediction_scores, local_preds, temps_masks

    def get_temp_and_mask(self, 
                          label, 
                          segments,
                          image,
                          exp,
